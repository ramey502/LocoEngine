...
import { ChevronDown, ChevronUp, Globe, Lock, Unlock } from "lucide-react";
...
const CustomHeader = ({ onPublish }: { onPublish: (data: Data) => void }) => {
  ...
  return (
    ...
    >
      <span style={{ fontWeight: 600 }}>puck example </span>
...
export function Client({ path, isEdit }: { path: string; isEdit: boolean }) {
  ...
  console.log("data.data", config, data, resolvedData);
